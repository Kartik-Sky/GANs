...
class Generator(nn.Module):
    def __init__(self,z_dim,channels_img,features_g):
        ...
        self.gen=nn.Sequential(
            ...
            self.block(features_g*16,features_g*8,4,2,1), # N x f_g*16  x 8 x 8
            self.block(features_g*8,features_g*4,4,2,1), # N x f_g*16 x 16 x 16
            self.block(features_g*4,features_g*2,4,2,1), # N x f_g*16 x 32 x 32
